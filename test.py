...
def get_args_parser():
    ...
    # parser.add_argument('--zero_loss_coef', default=4, type=float)
    # Loss
    ...
    parser.add_argument('--zero_loss_coef', default=1, type=float)
    # * Loss coefficients
    ...
    parser.add_argument('--checkpoint', default='/media/pc/other/VLTVG/checkpoint0067.pth', help='resume from checkpoint')
    ...
    # configure file
    parser.add_argument('--config',  default='/media/pc/other/VLTVG/configs/VLTVG_R101_referit.py',type=str, help='Path to the configure file.')
